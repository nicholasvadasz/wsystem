...
void MainWindow::setupUI() {
  ...
  trimesh_label->setText("Crystal Trimeshes");
  ...
  triangleCB->setText(QStringLiteral("Column Generator"));
  triangleCB->setChecked(true); // Default Triangle toggled

  //   pointButton = new QRadioButton(); // Point button
  //   pointButton->setText(QStringLiteral("Point"));
  //   pointButton->setChecked(false); // Default Triangle toggled
...
//   connect(sphereCB, &QRadioButton::clicked, this,
//   &MainWindow::onSphereChange);
// }
...
//   connect(cylinderCB, &QRadioButton::clicked, this,
//           &MainWindow::onCylinderChange);
// }
